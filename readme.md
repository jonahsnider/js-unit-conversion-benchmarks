...
Generated automatically at Wed, 01 Nov 2023 09:16:34 GMT with Node.js v18.18.2 (V8 v10.2.154.26-node.26) on fv-az445-186 (Linux-x64 Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz)
...
| [moment](https://npmjs.com/package/moment) (popular)               | `700`ns (350%)        | `700`ns (350%)                 | `1,428,571`/sec       |
...
| Library                                                            | Median execution time | 75th percentile execution time | Executions per second |
| ------------------------------------------------------------------ | --------------------- | ------------------------------ | --------------------- |
| [convert](https://npmjs.com/package/convert) (fast)                | `800`ns (100%)        | `800`ns (100%)                 | `1,250,000`/sec       |
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `35,423`ns (4,428%)   | `40,511`ns (5,064%)            | `28,230`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `50,719`ns (6,340%)   | `51,711`ns (6,464%)            | `19,716`/sec          |
