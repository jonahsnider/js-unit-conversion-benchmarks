...
Generated automatically at Sat, 25 Mar 2023 12:10:05 GMT with Node.js v18.15.0 (V8 v10.2.154.26-node.25) on fv-az622-394 (Linux-x64 Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `35,007`ns (5,001%)   | `37,919`ns (5,417%)            | `28,566`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `50,719`ns (7,246%)   | `51,615`ns (7,374%)            | `19,716`/sec          |
