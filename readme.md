...
Generated automatically at Fri, 18 Aug 2023 21:19:42 GMT with Node.js v18.17.1 (V8 v10.2.154.26-node.26) on fv-az357-697 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [luxon](https://npmjs.com/package/luxon) (popular)                 | `1,601`ns (1,585%)    | `1,701`ns (1,684%)             | `624,610`/sec         |
| [js-quantities](https://npmjs.com/package/js-quantities) (popular) | `3,401`ns (3,367%)    | `3,501`ns (3,466%)             | `294,031`/sec         |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `7,103`ns (7,033%)    | `7,203`ns (7,132%)             | `140,786`/sec         |
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `37,919`ns (5,409%)   | `41,823`ns (5,966%)            | `26,372`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `66,303`ns (9,458%)   | `67,903`ns (9,687%)            | `15,082`/sec          |
...
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `4,503`ns (4,458%)    | `4,503`ns (4,458%)             | `222,074`/sec         |
