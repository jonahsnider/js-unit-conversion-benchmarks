...
Generated automatically at Sat, 01 Jul 2023 12:33:45 GMT with Node.js v18.16.1 (V8 v10.2.154.26-node.26) on fv-az951-870 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `7,203`ns (3,602%)    | `7,403`ns (3,702%)             | `138,831`/sec         |
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `37,919`ns (5,409%)   | `41,503`ns (5,921%)            | `26,372`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `65,919`ns (9,404%)   | `67,711`ns (9,659%)            | `15,170`/sec          |
