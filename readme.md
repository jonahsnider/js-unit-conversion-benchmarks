...
Generated automatically at Sat, 30 Apr 2022 05:43:20 GMT with Node.js v18.0.0 (V8 v10.1.124.8-node.13) on fv-az198-991 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `7,003`ns (6,934%)    | `7,003`ns (6,934%)             | `142,796`/sec         |
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `33,119`ns (4,140%)   | `36,607`ns (4,576%)            | `30,194`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `66,623`ns (8,328%)   | `67,711`ns (8,464%)            | `15,010`/sec          |
...
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `4,503`ns (2,252%)    | `4,503`ns (2,252%)             | `222,074`/sec         |
