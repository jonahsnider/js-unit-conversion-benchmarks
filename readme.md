...
Generated automatically at Fri, 06 Mar 2026 05:07:50 GMT with Node.js v24.14.0 (V8 v13.6.233.17-node.41) on runnervm0kj6c (Linux-x64 AMD EPYC 7763 64-Core Processor)
...
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `1,674`ns (304%)      | `1,853`ns (336%)               | `597,372`/sec         |
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `25,391`ns (4,608%)   | `26,399`ns (4,791%)            | `39,384`/sec          |
