...
Generated automatically at Tue, 16 May 2023 05:09:10 GMT with Node.js v18.16.0 (V8 v10.2.154.26-node.26) on fv-az612-94 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `36,831`ns (4,604%)   | `40,319`ns (5,040%)            | `27,151`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `60,319`ns (7,540%)   | `62,303`ns (7,788%)            | `16,579`/sec          |
