...
Generated automatically at Wed, 08 Feb 2023 11:18:49 GMT with Node.js v18.14.0 (V8 v10.2.154.23-node.22) on fv-az210-387 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `37,311`ns (5,323%)   | `41,023`ns (5,852%)            | `26,802`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `59,519`ns (8,491%)   | `61,631`ns (8,792%)            | `16,801`/sec          |
