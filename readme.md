...
Generated automatically at Thu, 08 Sep 2022 04:17:03 GMT with Node.js v18.8.0 (V8 v10.2.154.13-node.11) on fv-az502-126 (Linux-x64 Intel(R) Xeon(R) Platinum 8171M CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `40,415`ns (4,042%)   | `44,415`ns (4,442%)            | `24,743`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `72,255`ns (7,226%)   | `74,559`ns (7,456%)            | `13,840`/sec          |
