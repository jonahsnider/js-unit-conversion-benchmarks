...
Generated automatically at Wed, 18 Oct 2023 05:01:20 GMT with Node.js v18.18.0 (V8 v10.2.154.26-node.26) on fv-az407-936 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `38,015`ns (4,224%)   | `44,223`ns (4,914%)            | `26,305`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `66,111`ns (7,346%)   | `68,031`ns (7,559%)            | `15,126`/sec          |
