...
Generated automatically at Thu, 01 Dec 2022 02:41:03 GMT with Node.js v18.12.1 (V8 v10.2.154.15-node.12) on fv-az471-431 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `6,703`ns (3,352%)    | `6,903`ns (3,452%)             | `149,187`/sec         |
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `33,119`ns (3,680%)   | `36,703`ns (4,078%)            | `30,194`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `60,831`ns (6,759%)   | `62,623`ns (6,958%)            | `16,439`/sec          |
