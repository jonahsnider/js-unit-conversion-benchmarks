...
Generated automatically at Wed, 18 Oct 2023 22:42:52 GMT with Node.js v18.18.2 (V8 v10.2.154.26-node.26) on fv-az337-812 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [luxon](https://npmjs.com/package/luxon) (popular)                 | `1,701`ns (1,684%)    | `1,701`ns (1,684%)             | `587,889`/sec         |
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `37,919`ns (4,734%)   | `44,031`ns (5,497%)            | `26,372`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `66,047`ns (8,246%)   | `68,607`ns (8,565%)            | `15,141`/sec          |
...
| [safe-units](https://npmjs.com/package/safe-units) (fast)          | `1,101`ns (1,090%)    | `1,201`ns (1,189%)             | `908,265`/sec         |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `4,403`ns (4,359%)    | `4,503`ns (4,458%)             | `227,118`/sec         |
