...
Generated automatically at Fri, 26 May 2023 02:44:05 GMT with Node.js v18.16.0 (V8 v10.2.154.26-node.26) on fv-az936-390 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `36,319`ns (5,181%)   | `39,903`ns (5,692%)            | `27,534`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `58,623`ns (8,363%)   | `60,031`ns (8,564%)            | `17,058`/sec          |
...
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `4,103`ns (2,041%)    | `4,103`ns (2,041%)             | `243,724`/sec         |
| [js-quantities](https://npmjs.com/package/js-quantities) (popular) | `4,503`ns (2,240%)    | `4,503`ns (2,240%)             | `222,074`/sec         |
