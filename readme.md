...
Generated automatically at Fri, 02 Dec 2022 14:08:12 GMT with Node.js v18.12.1 (V8 v10.2.154.15-node.12) on fv-az578-526 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `33,407`ns (4,176%)   | `37,023`ns (4,628%)            | `29,934`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `60,703`ns (7,588%)   | `63,007`ns (7,876%)            | `16,474`/sec          |
...
| [uom](https://npmjs.com/package/uom) (fast)                        | `401`ns (201%)        | `401`ns (201%)                 | `2,493,766`/sec       |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `800`ns (400%)        | `900`ns (450%)                 | `1,250,000`/sec       |
