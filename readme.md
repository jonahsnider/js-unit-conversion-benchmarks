...
Generated automatically at Fri, 24 Mar 2023 15:31:26 GMT with Node.js v18.15.0 (V8 v10.2.154.26-node.25) on fv-az560-829 (Linux-x64 Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `35,007`ns (5,825%)   | `37,919`ns (6,309%)            | `28,566`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `50,815`ns (8,455%)   | `51,615`ns (8,588%)            | `19,679`/sec          |
...
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `3,703`ns (1,852%)    | `3,801`ns (1,901%)             | `270,051`/sec         |
