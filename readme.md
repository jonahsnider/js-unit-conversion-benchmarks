...
Generated automatically at Wed, 11 May 2022 03:43:32 GMT with Node.js v18.1.0 (V8 v10.1.124.8-node.13) on fv-az290-742 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [safe-units](https://npmjs.com/package/safe-units) (fast)          | `800`ns (400%)        | `800`ns (400%)                 | `1,250,000`/sec       |
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `33,503`ns (4,183%)   | `36,703`ns (4,582%)            | `29,848`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `66,431`ns (8,294%)   | `67,711`ns (8,453%)            | `15,053`/sec          |
