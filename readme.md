...
Generated automatically at Wed, 01 Feb 2023 23:38:21 GMT with Node.js v18.13.0 (V8 v10.2.154.23-node.21) on fv-az422-252 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `36,031`ns (5,140%)   | `39,807`ns (5,679%)            | `27,754`/sec          |
