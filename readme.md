...
Generated automatically at Thu, 20 Apr 2023 04:21:17 GMT with Node.js v18.16.0 (V8 v10.2.154.26-node.26) on fv-az642-428 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `36,703`ns (5,236%)   | `40,223`ns (5,738%)            | `27,246`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `61,311`ns (8,746%)   | `63,807`ns (9,102%)            | `16,310`/sec          |
...
| [simple-units](https://npmjs.com/package/simple-units) (fast)      | `300`ns (297%)        | `300`ns (297%)                 | `3,333,333`/sec       |
| [uom](https://npmjs.com/package/uom) (fast)                        | `802`ns (794%)        | `900`ns (891%)                 | `1,246,883`/sec       |
...
| [js-quantities](https://npmjs.com/package/js-quantities) (popular) | `4,403`ns (4,359%)    | `4,403`ns (4,359%)             | `227,118`/sec         |
