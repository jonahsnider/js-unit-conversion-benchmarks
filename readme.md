...
Generated automatically at Wed, 16 Nov 2022 17:23:14 GMT with Node.js v18.12.0 (V8 v10.2.154.15-node.12) on fv-az424-297 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [dayjs](https://npmjs.com/package/dayjs) (popular)                 | `900`ns (891%)        | `1,000`ns (990%)               | `1,111,111`/sec       |
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `33,631`ns (4,798%)   | `37,023`ns (5,281%)            | `29,734`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `60,607`ns (8,646%)   | `62,815`ns (8,961%)            | `16,500`/sec          |
