...
Generated automatically at Tue, 21 Mar 2023 00:37:33 GMT with Node.js v18.15.0 (V8 v10.2.154.26-node.25) on fv-az561-435 (Linux-x64 Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz)
...
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `51,519`ns (7,349%)   | `52,415`ns (7,477%)            | `19,410`/sec          |
...
| [uom](https://npmjs.com/package/uom) (fast)                        | `901`ns (448%)        | `901`ns (448%)                 | `1,109,878`/sec       |
| [safe-units](https://npmjs.com/package/safe-units) (fast)          | `1,200`ns (597%)      | `1,200`ns (597%)               | `833,333`/sec         |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `3,801`ns (1,891%)    | `3,801`ns (1,891%)             | `263,089`/sec         |
| [js-quantities](https://npmjs.com/package/js-quantities) (popular) | `4,703`ns (2,340%)    | `4,703`ns (2,340%)             | `212,630`/sec         |
