...
Generated automatically at Tue, 01 Nov 2022 13:33:27 GMT with Node.js v18.12.0 (V8 v10.2.154.15-node.12) on fv-az72-871 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [simple-units](https://npmjs.com/package/simple-units) (fast)      | `300`ns (297%)        | `301`ns (298%)                 | `3,333,333`/sec       |
| [uom](https://npmjs.com/package/uom) (fast)                        | `801`ns (793%)        | `901`ns (892%)                 | `1,248,439`/sec       |
| [safe-units](https://npmjs.com/package/safe-units) (fast)          | `1,200`ns (1,188%)    | `1,301`ns (1,288%)             | `833,333`/sec         |
