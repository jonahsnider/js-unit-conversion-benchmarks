...
Generated automatically at Tue, 19 Jul 2022 19:45:18 GMT with Node.js v18.6.0 (V8 v10.2.154.13-node.8) on fv-az459-275 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `33,119`ns (4,725%)   | `37,631`ns (5,368%)            | `30,194`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `59,807`ns (8,532%)   | `63,423`ns (9,048%)            | `16,720`/sec          |
...
| [ms](https://npmjs.com/package/ms) (popular)              | `300`ns (100%)        | `401`ns (134%)                 | `3,333,333`/sec       |
