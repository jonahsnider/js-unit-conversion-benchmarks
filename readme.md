...
Generated automatically at Thu, 19 Oct 2023 10:58:03 GMT with Node.js v18.18.2 (V8 v10.2.154.26-node.26) on fv-az402-954 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [luxon](https://npmjs.com/package/luxon) (popular)                 | `1,701`ns (851%)      | `1,801`ns (901%)               | `587,889`/sec         |
| [js-quantities](https://npmjs.com/package/js-quantities) (popular) | `3,201`ns (1,601%)    | `3,301`ns (1,651%)             | `312,402`/sec         |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `7,103`ns (3,552%)    | `7,303`ns (3,652%)             | `140,786`/sec         |
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `37,823`ns (5,396%)   | `44,031`ns (6,281%)            | `26,439`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `66,431`ns (9,477%)   | `69,119`ns (9,860%)            | `15,053`/sec          |
