...
Generated automatically at Mon, 20 Mar 2023 11:28:18 GMT with Node.js v18.15.0 (V8 v10.2.154.26-node.25) on fv-az438-914 (Linux-x64 Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `35,103`ns (5,008%)   | `38,111`ns (5,437%)            | `28,488`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `52,127`ns (7,436%)   | `53,023`ns (7,564%)            | `19,184`/sec          |
