...
Generated automatically at Wed, 09 Aug 2023 08:24:55 GMT with Node.js v18.17.0 (V8 v10.2.154.26-node.26) on fv-az563-379 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `38,207`ns (5,450%)   | `41,919`ns (5,980%)            | `26,173`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `65,407`ns (9,331%)   | `66,815`ns (9,531%)            | `15,289`/sec          |
