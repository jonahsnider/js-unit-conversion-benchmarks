...
Generated automatically at Fri, 12 Aug 2022 17:28:21 GMT with Node.js v18.7.0 (V8 v10.2.154.13-node.9) on fv-az201-887 (Linux-x64 Intel(R) Xeon(R) Platinum 8171M CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `39,103`ns (4,345%)   | `43,231`ns (4,803%)            | `25,573`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `70,015`ns (7,779%)   | `71,551`ns (7,950%)            | `14,283`/sec          |
...
| [js-quantities](https://npmjs.com/package/js-quantities) (popular) | `3,703`ns (1,852%)    | `3,801`ns (1,901%)             | `270,051`/sec         |
