...
Generated automatically at Sat, 22 Jul 2023 02:01:19 GMT with Node.js v18.16.1 (V8 v10.2.154.26-node.26) on fv-az646-212 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `38,015`ns (4,752%)   | `41,727`ns (5,216%)            | `26,305`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `64,031`ns (8,004%)   | `65,215`ns (8,152%)            | `15,617`/sec          |
