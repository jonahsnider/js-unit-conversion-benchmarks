...
Generated automatically at Fri, 21 Jul 2023 03:52:24 GMT with Node.js v18.16.1 (V8 v10.2.154.26-node.26) on fv-az797-952 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [simple-units](https://npmjs.com/package/simple-units) (fast)      | `300`ns (297%)        | `401`ns (397%)                 | `3,333,333`/sec       |
...
| [luxon](https://npmjs.com/package/luxon) (popular)                 | `1,500`ns (1,485%)    | `1,601`ns (1,585%)             | `666,667`/sec         |
| [js-quantities](https://npmjs.com/package/js-quantities) (popular) | `3,201`ns (3,169%)    | `3,201`ns (3,169%)             | `312,402`/sec         |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `7,303`ns (7,231%)    | `7,503`ns (7,429%)             | `136,930`/sec         |
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `37,919`ns (5,409%)   | `41,631`ns (5,939%)            | `26,372`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `65,311`ns (9,317%)   | `67,647`ns (9,650%)            | `15,311`/sec          |
...
| [js-quantities](https://npmjs.com/package/js-quantities) (popular) | `3,401`ns (1,701%)    | `3,403`ns (1,702%)             | `294,031`/sec         |
