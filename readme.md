...
Generated automatically at Wed, 10 Aug 2022 21:16:46 GMT with Node.js v18.7.0 (V8 v10.2.154.13-node.9) on fv-az456-113 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `33,503`ns (4,188%)   | `37,215`ns (4,652%)            | `29,848`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `60,831`ns (7,604%)   | `63,007`ns (7,876%)            | `16,439`/sec          |
