...
Generated automatically at Tue, 19 Apr 2022 04:46:55 GMT with Node.js v16.14.2 (V8 v9.4.146.24-node.20) on fv-az290-959 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `6,703`ns (3,352%)    | `6,703`ns (3,352%)             | `149,187`/sec         |
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `31,807`ns (3,976%)   | `32,303`ns (4,038%)            | `31,440`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `61,407`ns (7,676%)   | `62,207`ns (7,776%)            | `16,285`/sec          |
...
| [safe-units](https://npmjs.com/package/safe-units) (fast)          | `1,101`ns (551%)      | `1,102`ns (551%)               | `908,265`/sec         |
