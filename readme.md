...
Generated automatically at Sat, 26 Feb 2022 04:59:12 GMT with Node.js v16.14.0 (V8 v9.4.146.24-node.20) on fv-az216-998 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [dayjs](https://npmjs.com/package/dayjs) (popular)                 | `800`ns (792%)        | `900`ns (891%)                 | `1,250,000`/sec       |
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `28,911`ns (4,124%)   | `29,503`ns (4,209%)            | `34,589`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `54,623`ns (7,792%)   | `55,615`ns (7,934%)            | `18,307`/sec          |
...
| [js-quantities](https://npmjs.com/package/js-quantities) (popular) | `2,801`ns (1,401%)    | `3,101`ns (1,551%)             | `357,015`/sec         |
