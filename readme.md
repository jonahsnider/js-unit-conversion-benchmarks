...
Generated automatically at Tue, 07 Nov 2023 18:04:35 GMT with Node.js v18.18.2 (V8 v10.2.154.26-node.26) on fv-az795-638 (Linux-x64 Intel(R) Xeon(R) Platinum 8171M CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `44,831`ns (4,981%)   | `52,031`ns (5,781%)            | `22,306`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `78,335`ns (8,704%)   | `80,127`ns (8,903%)            | `12,766`/sec          |
...
| [convert](https://npmjs.com/package/convert) (fast)                | `301`ns (150%)        | `301`ns (150%)                 | `3,322,259`/sec       |
| [simple-units](https://npmjs.com/package/simple-units) (fast)      | `301`ns (150%)        | `301`ns (150%)                 | `3,322,259`/sec       |
| [uom](https://npmjs.com/package/uom) (fast)                        | `1,001`ns (498%)      | `1,001`ns (498%)               | `999,001`/sec         |
...
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `5,303`ns (2,638%)    | `5,303`ns (2,638%)             | `188,573`/sec         |
