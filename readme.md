...
Generated automatically at Mon, 04 Sep 2023 18:59:28 GMT with Node.js v18.17.1 (V8 v10.2.154.26-node.26) on fv-az359-854 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `37,503`ns (4,688%)   | `41,215`ns (5,152%)            | `26,665`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `64,703`ns (8,088%)   | `66,047`ns (8,256%)            | `15,455`/sec          |
