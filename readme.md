...
Generated automatically at Sun, 31 Jul 2022 00:26:35 GMT with Node.js v18.7.0 (V8 v10.2.154.13-node.9) on fv-az41-358 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `33,119`ns (4,725%)   | `36,831`ns (5,254%)            | `30,194`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `59,007`ns (8,418%)   | `60,415`ns (8,618%)            | `16,947`/sec          |
