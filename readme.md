...
Generated automatically at Sat, 10 Dec 2022 23:18:08 GMT with Node.js v18.12.1 (V8 v10.2.154.15-node.12) on fv-az248-972 (Linux-x64 Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `32,207`ns (4,594%)   | `35,103`ns (5,008%)            | `31,049`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `51,327`ns (7,322%)   | `52,319`ns (7,463%)            | `19,483`/sec          |
