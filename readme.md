...
Generated automatically at Wed, 20 Sep 2023 07:17:06 GMT with Node.js v18.17.1 (V8 v10.2.154.26-node.26) on fv-az396-476 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [luxon](https://npmjs.com/package/luxon) (popular)                 | `1,800`ns (1,782%)    | `1,801`ns (1,783%)             | `555,556`/sec         |
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `37,631`ns (4,704%)   | `43,711`ns (5,464%)            | `26,574`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `65,311`ns (8,164%)   | `67,007`ns (8,376%)            | `15,311`/sec          |
