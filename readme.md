...
Generated automatically at Sat, 27 May 2023 00:23:43 GMT with Node.js v18.16.0 (V8 v10.2.154.26-node.26) on fv-az553-8 (Linux-x64 Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz)
...
| [byte-size](https://npmjs.com/package/byte-size) (popular)         | `36,703`ns (4,588%)   | `40,511`ns (5,064%)            | `27,246`/sec          |
| [convert-units](https://npmjs.com/package/convert-units) (popular) | `59,807`ns (7,476%)   | `61,503`ns (7,688%)            | `16,720`/sec          |
